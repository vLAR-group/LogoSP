...
def write_ply(points_3d, filename, binary=True, with_label=False, verbose=True):
    ...
    if with_label:
        ...
        if points_3d.shape[1] == 8:
            ...
            npy_types = [('x', 'f4'), ('y', 'f4'), ('z', 'f4'), ('red', 'u1'), ('green', 'u1'),
                     ('blue', 'u1'), ('class', 'f4'), ('instance', 'f4')]
        if points_3d.shape[1] == 5:
            python_types = (float, float, float, float, float)
            npy_types = [('x', 'f4'), ('y', 'f4'), ('z', 'f4'), ('remission', 'f4'), ('class', 'f4')]
