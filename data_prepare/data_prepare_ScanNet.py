...
parser.add_argument('--data_path', type=str, default='/home/zihui/SSD/GrabS/data/scannet/raw', help='raw data path')
parser.add_argument('--processed_data_path', type=str, default='../data/ScanNet/processed')
parser.add_argument('--processed_sp_path', type=str, default='../data/ScanNet/Felzenszwalb')
parser.add_argument('--Felzenszwalb', type=bool, default=True)
